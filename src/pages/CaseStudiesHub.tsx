  ...
  return (
    <main className="px-6 py-16 max-w-7xl mx-auto">
      <SEO
        ...
        path="/case-studies"
      />
      <h1 className="font-display font-bold text-ink text-[clamp(2rem,5vw,3rem)]">Case Studies</h1>
      <p className="font-body text-base text-muted mt-3 max-w-[60ch]">
        14+ years of shipping data platforms, AI products, and growth wins — filterable by category and career stage.
      </p>
          ...
          return (
            <button
              ...
              className={`font-body text-sm transition-colors duration-200 ${
                active ? 'text-accent underline font-semibold' : 'text-muted hover:text-accent'
              }`}
            >
              {category}
            </button>
      ...
      <input
        ...
        className="mt-6 w-full max-w-md font-body text-base text-ink bg-surface border border-border rounded-DEFAULT px-4 py-3 focus:outline-none focus:border-accent"
      />
