...
const variantClasses: Record<Variant, string> = {
  ...
  secondary:
    'bg-transparent text-accent border-2 border-accent font-body font-semibold text-sm px-6 py-3.5 min-h-12 rounded transition-colors duration-200 hover:bg-accent hover:text-white',
  text:
